...
int main(int argc, char *argv[])
{
	...
	for (i = 0; i < byte; i++)
	{
		if (str[i] == 0xE2 && str[i + 1] == 0x80 && str[i + 2] == 0xA6) // ...
		{
			str[i] = str[i + 1] = str[i + 2] = '.';
			
			i += 2;
		}
		else if (str[i] == 0xE2 && str[i + 1] == 0x80 && (str[i + 2] == 0x99 || str[i + 2] == 0x98)) // kesme işareti
		{
			str[i] = 39;
		...
		else if (str[i] == 0xE2 && str[i + 1] == 0x80 && (str[i + 2] == 0x9C || str[i + 2] == 0x9D)) // "
		{
			str[i] = 34;
		...
		else if (str[i] == 0xE2 && str[i + 1] == 0x80 && str[i + 2] == 0x93) // -
		{
			str[i] = '-';
		...
		else if (str[i] == 0xC3 && str[i + 1] == 0x87) // Ç
		{
			str[i] = 0xC7;
			str[i + 1] = 32;
